...
video_path=r"Video dataset\PF_EdgeCrossing_5.avi"
...
while True:
    ...
    for output in results:
        ...
        for box in parameter:
            ...
            class_detect=class_names[class_detect]
            if direction=="L":
                if confidence>0.3 and class_detect == "person" and is_crossing_line(edge_x_bottom,edge_y_bottom,edge_x_top,edge_y_top,center_x,y+h):
                    cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 0,225), 2)
                    cv2.putText(frame, "!!!ON THE TRACK!!!", (x, y-10), font, 1, (0, 0,225), 2)
                elif confidence>0.3 and class_detect == "person" and is_crossing_line(line_x_bottom,line_y_bottom,line_x_top,line_y_top,center_x,y+h):  # Check crossing line for this person only
                    cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 225, 225), 2)
                    cv2.putText(frame, "Line Crossing!", (x, y-10), font, 1, (0, 225, 225), 2)
                elif confidence>0.3 and class_detect == "person":
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (225,0,0), 2)
                    cv2.putText(frame, class_detect, (x, y - 5), font, 1, (225,0,0), 2)
            elif direction=="R":
                if confidence>0.3 and class_detect == "person" and is_crossing_line(edge_x_top,edge_y_top,edge_x_bottom,edge_y_bottom,center_x,y+h):
                    cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 0,225), 2)
                    cv2.putText(frame, "!!!ON THE TRACK!!!", (x, y-10), font, 1, (0, 0,225), 2)
                elif confidence>0.3 and class_detect == "person" and is_crossing_line(line_x_top,line_y_top,line_x_bottom,line_y_bottom,center_x,y+h):  # Check crossing line for this person only
                    cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 225, 225), 2)
                    cv2.putText(frame, "Line Crossing!", (x, y-10), font, 1, (0, 225, 225), 2)
                elif confidence>0.3 and class_detect == "person":
                    cv2.rectangle(frame, (x, y), (x + w, y + h), (225,0,0), 2)
